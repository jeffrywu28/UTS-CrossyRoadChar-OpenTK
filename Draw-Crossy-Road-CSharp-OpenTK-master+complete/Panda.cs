...
namespace ConsoleApp2
{
    class Panda
    {
        ...
        Matrix4 _view;
        Matrix4 _projection;
        public List<Panda> Child = new List<Panda>();//biar bisa pny child masing2

        public Panda(String color = "")
        {
            this.color = color;
        ...
        public void createBodyPanda(float x, float y, float z, float length, String m_color)//ttik pusat dari box dimana
        {//length panjang dari titik kubus
        ...
        {
            Panda newChild = new Panda(color);
        ...
        {
            Panda newChild = new Panda(m_color);
